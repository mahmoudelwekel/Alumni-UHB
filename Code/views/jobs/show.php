...
<div class="card shadow mb-4" style="background-image:url('<?= asset("Images/bg/empty.jpg") ?>') ;
background-repeat: no-repeat;
    background-size: contain;
    background-position: right;
    background-color: #e5f1ed;">
        ...
        <div class="card-body font-weight-bold">
            <h4 class="card-title font-weight-bold h3 text-dark text-left">job Title</h4>
            <hr />
            ...
            <div class="row card-text">
                ...
                <div class="col h5  font-weight-bold no-text-wrap">
                    <i class="icon far fa-clock "></i> Details
                </div>
